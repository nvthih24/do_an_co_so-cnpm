  ...
  if (!employer) {
    return (
      <div className="flex flex-col items-center justify-center p-8">
        ...
        <Button onClick={() => navigate('/employer')}>Back to Employers</Button>
      </div>
    );
  }
                    ...
                    <CardContent>
                      <div className="relative">
                        ...
                        <ul className="space-y-6">
                          ...
                          {employer.status !== 'pending' && (
                            <li className="relative pl-12">
                              <span className={`absolute left-4 -translate-x-1/2 w-4 h-4 rounded-full border-4 border-white dark:border-gray-800 ${employer.status === 'approved' ? 'bg-green-500' : 'bg-red-500'
                                }`}></span>
                              <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
